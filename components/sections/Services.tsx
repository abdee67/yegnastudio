  ...
  return (
    <section id="services" className="py-24 px-8">
      <div className="max-w-[1100px] mx-auto">
        ...
        <StaggerContainer className="grid grid-cols-1 md:grid-cols-3 gap-[1px] bg-[var(--border)] border border-[var(--border)] rounded-[20px] overflow-hidden mt-12">
          {SERVICES.map((service) => (
            <StaggerItem key={service.title}>
              <div className="bg-[var(--black)] p-8 hover:bg-[var(--surface)] cursor-default">
