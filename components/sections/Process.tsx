...
export default function Process() {
  ...
  return (
    <section id="process" className="py-24 px-8" ref={ref}>
      <div className="max-w-[1100px] mx-auto">
        ...
        <div className="mt-12 flex flex-col">
          {PROCESS_STEPS.map((step, i) => (
            <div
              key={i}
              className="grid grid-cols-[50px_1fr] md:grid-cols-[80px_1fr] gap-4 md:gap-8 py-8 border-b border-[var(--border)] last:border-b-0 items-start group scroll-fade"
            >
              <div className="display-font text-[2rem] md:text-[3rem] font-extrabold text-[var(--border)] leading-none transition-colors duration-300 group-hover:text-[var(--accent)]">
                {step.num}
              </div>
              <div>
        ...
        <div className="bg-[var(--surface)] border border-[var(--border)] rounded-3xl p-8 md:p-12 mt-12 relative overflow-hidden scroll-fade">
          <div
